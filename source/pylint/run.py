...
# Output to Github  
print(f"::set-output name=pylint_errors::{total_errors}")
print(f"::set-output name=pylint_warnings::{total_warnings}")
print(f"::set-output name=pylint_suggestions::{total_suggestions}")
