...
class GitIssue:
    ...
    def from_lint(lints: List[LintIssue], users: Set[str], repo: str, after: str):
        ...
        common_issues = {
            ...
            "E0402": "This issue is often flagged by pylint because it is unsure of the Python context that the script will be run in. If you are sure that this import is ok, you can disable the error by adding the line `# pylint: disable=E0402` above the import."
        }
